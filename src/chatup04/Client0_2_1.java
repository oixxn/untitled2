...
//            new GetMsgFroServer().start();
            s=new SendMsgtoServer();
            threadPool.add(new Thread(s));
            s.start();
            g=new GetMsgFroServer();
            threadPool.add(new Thread(g));
            g.start();
...
//                                                new closeQ().close();
                                               threadPool.remove(new Thread(s));
    ...
    public class closeQ{
        public void close(){
//            threadPool.remove(new Thread(s));
//            threadPool.remove(new Thread(g));
            try {
